...
$\begin{cases}
    \text{中性分子} \\
    \text{自由基(中性):特殊自由基$\chemfig{\charge{0=\:,90=\:,180=\:,-90=\:}{Cl}}$氯自由基} \\
    \text{离子(带电)}
\end{cases}$
...
$\chemfig{\charge{90=\:,-90=\:}{O}(-[:-140]H)(-[:-40]H)}\rightarrow
\begin{cases}
    \text{O原子独享}
    \begin{cases}
        \text{孤电子} \\
...
\qquad
\chemfig{\charge{-90=\.}{C}(-[:0])(-[:180])([:-90])(-[:90])}
\qquad
...
\label{sec:1.1.5}
CO \qquad
$\chemfig{\charge{0=\.,-90=\.,180=\.,90=\.}{C}(-[:-90,.65]\charge{90=\.,-90=\.,180=\:,0=\:}{O})}\quad \rightarrow\quad
\chemfig{\charge{-90=\:,90=\:}{C}(-[:-90,.65]\charge{90=\:,180=\:,0=\:}{O})}\quad \rightarrow\quad
\chemfig{\charge{90=\:}{C}(=[:-90]\charge{180=\:,0=\:}{O})}\quad \rightarrow\quad
\overset{\text{C不满足八隅体规则}}{\chemfig{\charge{180=\:}{O^{\oplus}}}\ce{->[==]}\chemfig{\charge{0=\:}{^{\oplus}C}}}$
配位键:$\underset{\text{$\delta+/\delta-$部分电荷中心}}{\overset{\delta-}{\ce{C}}\ce{<-[==]}\overset{\delta+}{\ce{O}}}$

NO(长命自由基):
\chemfig{\charge{0=\:,-90=\:,180=\:}{O}(-[:-90,.65]\charge{90=\:,-90=\:,180=\.}{N})}$\quad \rightarrow\quad \overset{7e^-}{\chemfig{\charge{180=\.,-90=\:}{N}}}=\underset{8e^-}{\chemfig{\charge{90=\:,-90=\:,180=\:}{O}}}\quad 6-4-2=0$
...
以$H_2O$的Lewis结构式为例
$\chemfig{\charge{90=\:,-90=\:}{O}(-[:-140]H)(-[:-40]H)}
\begin{cases}
...
\begin{figure}[H]
    ...
    \begin{subcaptionbox}
        \begin{tikzpicture}[scale=.5]
            ...
            \draw[->] (1.5,0)--(2.5,-.8)node[right]{节面};
            \node[right] at (2,1) {2s};
            \node[right] at (0,0) {1s};
          \end{tikzpicture}
    \end{subcaptionbox}
...
\begin{figure}[H]
    \begin{tikzpicture}[scale=.7]
        \draw[-] (0,.5)--(3,.5)node[above,pos=.5]{正相位}node[right]{$\Psi>0$};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.7]
        \shade[ball color=black!20] (0,0)circle (.5);
...
\begin{figure}[H]
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[scale=.6]
            ...
            \shade[ball color=black!20] (.2,.2)circle (.4);
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[scale=.6]
            \draw[->] (0,-1.5)--(0,1.5)node[right]{z};
            \node[below] at (0,-2) {py};
            \shade[ball color=black!20] (-.3,0)circle (.4);
            \draw[->] (-1.5,0)--(1.5,0)node[below]{y};
            \draw[->] (1,1)--(-1,-1)node[below]{x};
            \shade[ball color=black!20] (.3,0)circle (.4);
        \end{tikzpicture}
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[scale=.6]
            \draw[->] (-1.5,0)--(1.5,0)node[below]{y};
            \shade[ball color=black!20] (0,-.3)circle (.4);
            \draw[->] (1,1)--(-1,-1)node[below]{x};
            \draw[->] (0,-1.5)--(0,1.5)node[right]{z};
            \node[below] at (0,-2) {pz};
            \draw[-] (-.6,.6)--(1.8,.6);
    ...
    \begin{subcaptionbox}
        \begin{tikzpicture}[scale=.6]
            \draw[->] (1,1)--(-1,-1)node[below]{x};
            \begin{scope}[rotate around={45:(.29,.29)}]
                \shade[ball color=black!20] (.29,.29)ellipse (.4 and .2);
            \end{scope}
            \begin{scope}[rotate around={45:(-.28,-.28)}]
                \shade[draw=black] (-.28,-.28)ellipse (.4 and .2);
            \end{scope}
        \end{tikzpicture}
    \end{subcaptionbox}
    \hfill
    \begin{subcaptionbox}
        \begin{tikzpicture}[scale=.6]
            \draw[->] (-1.5,0)--(1.5,0)node[below]{y};
            \shade[ball color=black!20] (-.4,0)ellipse (.4 and .2);
            \shade[draw=black] (.4,0)ellipse (.4 and .2);
        \end{tikzpicture}
    \end{subcaptionbox}
    \hfill
    \begin{subcaptionbox}
        \begin{tikzpicture}[scale=.6]
            \draw[->] (0,-1.5)--(0,1.5)node[right]{z};
            \shade[ball color=black!20] (0,-.4)ellipse (.2 and .4);
            \shade[draw=black] (0,.4)ellipse (.2 and .4);
        \end{tikzpicture}
    \end{subcaptionbox}
    \caption{p轨道的几何分布}
    \label{f1.2}
...
\begin{figure}[H]
    \begin{tikzpicture}
        ...
        \draw[thick] (0,0) arc (0:-90:1.5 and .5);
        \draw[thick] (0,0) arc (0:90:-1.5 and .5);
        \draw[-] (-.75,-.25)--(-.75,-.25)node[black]{-};
        \draw[-] (.75,.25)--(.75,.25)node[black]{+};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=.5]
        ...
        \draw (.4,2.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0);
        \draw (1,1.5)--node{$\uparrow\downarrow$}+(1,0)node[right]{2s};
        \draw (1,.5)--node{$\uparrow\downarrow$}+(1,0)node[right]{1s};
...
\begin{figure}[H]
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[baseline=(current bounding box.center),scale=.6]
            \draw[draw=black] (1.3,.9)ellipse (.3 and .6);
            \chemfig[atom sep=2.4em]{\charge{90=\:}{N}(-[:-90]H)(-[:180]H)(-[:0]H)};
            \draw[->] (3,0)--(5.5,0)node[above,pos=.5]{不考虑}node[below,pos=.5]{斥力大小};
        \end{tikzpicture}
    \end{subcaptionbox}
    \begin{subcaptionbox}
        \centering
        \begin{tikzpicture}[baseline=(current bounding box.center),scale=.6]
            \draw[draw=black] (.9,.9)ellipse (.3 and .6);
            \chemfig[atom sep=2.4em]{\charge{90=\:}{N}(-[:-80]H)(-[:-30]H)(-[:-130]H)};
            \draw[->] (3.5,.2)--(5.5,.2);
            \draw[<->] (1.5,-.2) arc (0:25:3)node[right,pos=.5]{$\underset{\text{实际107°}}{\text{109°}}$};
        \end{tikzpicture}
    \end{subcaptionbox}
    \begin{subcaptionbox}
        \centering
        \begin{tikzpicture}[baseline=(current bounding box.center),scale=.6]
            \draw[draw=black] (.9,.9)ellipse (.3 and .6);
            \chemfig[atom sep=2.4em]{\charge{90=\:}{N}(-[:-80]H)(-[:-30]H)(-[:-130]H)};
            \draw[<->] (1.5,-.2) arc (0:25:3)node[right,pos=.5]{$\theta_1$};
            \draw[<->] (1,-.5)--(.5,-.3)node[below,pos=.5]{$\theta_2$};
            \draw[-] (4,0)--(4,0)node[above,pos=.5]{$\theta_1>\theta_2$}node[below,pos=.5]{$\theta_2<109.5°$};
        \end{tikzpicture}
    \end{subcaptionbox}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[scale=.6]
            ...
            \begin{scope}[rotate around={105:(.5,-1)}]
                \draw[thick] (.5,-1) ellipse (1 and .3);
            \end{scope}
            \begin{scope}[rotate around={55:(-.3,-.8)}]
                \draw[thick] (-.3,-.8) ellipse (1 and .3);
            \end{scope}
            \begin{scope}[rotate around={105:(0,1)}]
                \draw[thick] (0,1) ellipse (1 and .3);
            \end{scope}
            \begin{scope}[rotate around={0:(1.3,0)}]
                \draw[thick] (1.3,0) ellipse (1 and .3);
            \end{scope}
            \draw[<->] (1.5,.4) arc (0:90:1)node[right,pos=.5]{109°18'};
        \end{tikzpicture}
    \end{subcaptionbox}
    \hfill
    \begin{subcaptionbox}
        \begin{tikzpicture}[scale=.7]
            ...
            \begin{scope}[rotate around={90:(0,.6)}]
                \draw[thick] (0,.6) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={90:(0,-.6)}]
                \draw[thick,dashed] (0,-.6) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={45:(-.45,-.45)}]
                \draw[thick] (-.45,-.45) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={160:(.55,-.2)}]
                \draw[thick] (.55,-.2) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={120:(-.3,.5)}]
                \draw[thick] (-.3,.5) ellipse (.6 and .2);
            \end{scope}
            \draw[-,dashed] (-.45,-.45)--(.55,-.2);
            \draw[-,dashed] (-.45,-.45)--(-.3,.5);
            \draw[-] (.55,-.2)--(-.3,.5);
        \end{tikzpicture}
    \end{subcaptionbox}
    \hfill
    \begin{subcaptionbox}
        \begin{tikzpicture}[scale=.7]
            ...
            \begin{scope}[rotate around={90:(0,-.6)}]
                \draw[thick,dashed] (0,-.6) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={0:(.6,0)}]
                \draw[thick] (.6,0) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={0:(-.6,0)}]
                \draw[thick] (-.6,0) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={45:(-.45,-.45)}]
                \draw[thick] (-.45,-.45) ellipse (.6 and .2);
            \end{scope}
            \begin{scope}[rotate around={45:(.4,.5)}]
                \draw[thick,dashed] (.4,.4) ellipse (.6 and .2);
            \end{scope}
            \draw[-] (-1,1.5)--(1.4,1.5);
            \draw[-] (-1,1.5)--(-1.4,-1.5);
            \draw[-] (1,-1.5)--(1.4,1.5)node[right,pos=.25]{$\pi_1\perp\pi_2$};
            \draw[-] (-1.4,-1.5)--(1,-1.5);
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=.5]
        \draw[->] (0,0)--(0,4)node[right]{Eorb};
        \draw (.5,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.4]
        ...
        \draw (.5,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0);
...
\begin{figure}[H]
    ...
    \end{cases}$
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        \draw[draw=black] (-.4,0)ellipse (.4 and .2);
        \shade[ball color=black!20] (.6,0)ellipse (.6 and .3);
        \draw[draw=black] (-.4,1)ellipse (.4 and .2);
        \shade[ball color=black!20] (.6,1)ellipse (.6 and .3);
        \node[right] at (1.5,1) {$+$};
        \node[right] at (1.5,0) {$+$};
        \shade[ball color=black!20] (3,1)circle (.3);
        \draw[draw=black] (3,0)circle (.3);
        \draw[->] (3.5,1)--(4,1)node[right]{$\sigma$};
        \draw[->] (3.5,0)--(4,0)node[right]{$\sigma^*$};
        \draw[-,red] (5,-.4)--(15.5,-.4)node[right]{};
        \draw[-,red] (5,1.4)--(15.5,1.4)node[red,right]{$\star$};
        \draw[-,red] (5,-.4)--(5,1.4)node[red,right,pos=.5]{轨道有效重叠的程度越高，整体能量越低};
        \draw[-,red] (15.5,-.4)--(15.5,1.4)node[right]{};
    \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.4]
        ...
        \draw (.5,1.5)--node{$\uparrow\downarrow$}+(1,0)node[below]{$sp^3$};
        \draw (1.7,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
        \draw (2.9,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
        \draw (4.1,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
        \draw[decorate,decoration={brace, amplitude=2, mirror}, line width=.8] (2,.2)--(5.3,.2)node[below]{与3个H的1s成键};
        ...
        \draw[->] (10.5,1.5)--(14,1.5)node[red,pos=.5,above]{简化}node[red,pos=.5,below]{省略组合过程};
...
\begin{figure}[H]
    \begin{tikzpicture}[scale=.5]
        ...
        \draw (1,-.25)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[left,pos=0]{$sp^2$};
        ...
        \draw (7,.25)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[right]{$sp^2$};
        ...
        \draw[->] (6,4)--(10,4.5);
        \shade[ball color=black!20] (11,4.9)ellipse (.2 and .4);
        \draw[draw=black] (11,4.1)ellipse (.2 and .4);
        \node[black] at (12.5,4.5) {+};
        \draw[draw=black] (14,4.9)ellipse (.2 and .4);
        \shade[ball color=black!20] (14,4.1)ellipse (.2 and .4);
        \draw[->] (15,4.5)--(16,4.5);
        \begin{scope}[rotate around={45:(16.5,4.1)}]
            \draw[draw=black] (16.5,4.1)ellipse (.4 and .2);
        \end{scope}
        \begin{scope}[rotate around={45:(17.5,4.9)}]
            \draw[draw=black] (17.5,4.9)ellipse (.4 and .2);
        \end{scope}
        \begin{scope}[rotate around={135:(16.5,4.9)}]
            \shade[ball color=black!20] (16.5,4.9)ellipse (.4 and .2);
        \end{scope}
        \begin{scope}[rotate around={135:(17.5,4.1)}]
            \shade[ball color=black!20] (17.5,4.1)ellipse (.4 and .2);
        \end{scope}
        \node[black] at (18,4.5) {$\pi^*$};
        \draw[->] (6,1)--(10,.5);
        \shade[ball color=black!20] (11,.9)ellipse (.2 and .4);
        \draw[draw=black] (11,.1)ellipse (.2 and .4);
        \node[black] at (12.5,.5) {+};
        \shade[ball color=black!20] (14,.9)ellipse (.2 and .4);
        \draw[draw=black] (14,.1)ellipse (.2 and .4);
        \draw[->] (15,.5)--(16,.5);
        \shade[ball color=black!20] (17,.8)ellipse (.4 and .2);
        \draw[draw=black] (17,.2)ellipse (.4 and .2);
        \node[black] at (18,.5) {$\pi$};
    \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.4]
        ...
        \draw[->] (0,-1)--(0,5)node[right]{Eorb}node[left,pos=.25]{断键\quad $\text{优先}\pi\text{，其次}\sigma$}node[left,pos=.75]{给电子能力\quad 单键<双键<孤对电子};
    \end{tikzpicture}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=.4]
        ...
        \node[above] at (5,-4.2) {MOT};
        \node[below] at (5,-4.2) {$\downarrow$};
        \node[right] at (3.5,-5.5) {HOMO/LUMO(前线轨道理论)};
    \end{tikzpicture}
\end{figure}