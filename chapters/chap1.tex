...
\chemfig{C^{\oplus}(-[:0,0.8])(-[:180,0.8])([:-90,0.8])(-[:90,0.8])}
\qquad
\chemfig{C^{*}(-[:0,0.8])(-[:180,0.8])([:-90,0.8])(-[:90,0.8])}
\qquad
\chemfig{C^{\ominus}(-[:0,0.8])(-[:180,0.8])([:-90,0.8])(-[:90,0.8])}
...
$\chemfig{O^{\oplus}(-[:0,0.8])(-[:180,0.8])(-[:90,0.8])}\quad 6-2-3=+1$
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        \draw[-](1,3.5)--(2,3.5)node[right]{能量大};
        \draw[-](1,3)--(2,3);
        \draw[-](1,2.5)--(2,2.5);
        \draw[-](1,2)--(2,2);
        \draw[-](1,1.5)--(2,1.5);
    ...
    \begin{subcaptionbox}
        \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
            ...
            \draw[red, dashed] (center) circle (1.5);
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        ...
        \draw (1,1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (1,1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{2s};
        \draw (1,0.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (1,0.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{1s};
        ...
        \draw (8,1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (8,1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{2s};
        \draw (15.4,2.5)--++(.5,0)-- ++(.5,0)node[below]{pz};
        \draw (13.4,2.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{py};
        \draw (11.4,2.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{px};
        \draw (13,1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (13,1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0);
    \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[baseline=(current bounding box.center),scale=.6]
            ...
            \chemfig{N(-[:-90,0.8]H)(-[:180,0.8]H)(-[:0,0.8]H)};
    ...
    \begin{subcaptionbox}
        ...
        \begin{tikzpicture}[baseline=(current bounding box.center),scale=.6]
            ...
            \chemfig{N(-[:-80,0.8]H)(-[:-30,0.8]H)(-[:-130,0.8]H)};
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        \draw (2.8,2.5)--++(.5,0)-- ++(.5,0)node[right]{2p};
...
$\uwave{\text{原子之间通过共享电子}}\overset{\textcolor{red}{\text{共价键}}}{\overset{\textcolor{red}{\uparrow}}{\uwave{\text{成键}}}}
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.4]
        ...
        \draw (7.3,3.5)--++(.5,0)-- ++(.5,0)node[right]{$\Psi_2'$};
        \draw (7.3,-1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0)node[right]{$\Psi_1'$};
        \draw (7.3,-1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0);
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        ...
        \draw[-,red] (5,1.4)--(15.5,1.4)node[red,right]{*};
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        \draw (1,4)--++(.5,0)-- ++(.5,0)node[right]{$\Psi_4$};
        \draw (1,3)--++(.5,0)-- ++(.5,0)node[right]{$\Psi_3$};
        \draw (1,2)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (1,2)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{$\Psi_2$};
        \draw (1,1)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (1,1)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{$\Psi_1$};
...
\label{sec:1.3.2}
孤对电子的分子轨道$\rightarrow$孤对电子不参与成键，可以叫做“非键”

\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.4]
        \draw[->](0,-2)--(0,4)node[right]{以$CH_3$为例:};
        \draw (0.5,1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (0.5,1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[below]{$sp^3$};
        \draw (1.7,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
        \draw (2.9,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
        \draw (4.1,1.5)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^3$};
        ...
        \draw (6.3,3.5)--++(.5,0)-- ++(.5,0)node[right]{$\sigma^*_{N-H}$};
        \draw (6.3,-1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (6.3,-1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{$\sigma_{N-H}$};
        ...
        \draw (16,0)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (16,0)--++(.7,0)node{$\downarrow$}-- ++(.3,0);
        \draw (17.2,0)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (17.2,0)--++(.7,0)node{$\downarrow$}-- ++(.3,0);
        \draw (18.4,0)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (18.4,0)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{3个$\sigma_{N-H}$};
        \draw (17.2,1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (17.2,1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{$sp_N^3$};
        \draw[->](20,1.5)--(21,1.5)node[right]{孤对电子保持原有轨道};
        \draw (16,3)--++(.5,0)-- ++(.5,0);
        \draw (17.2,3)--++(.5,0)-- ++(.5,0);
        \draw (18.4,3)--++(.5,0)-- ++(.5,0)node[right]{3个$\sigma^*_{N-H}$};
    \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.5]
        ...
        \draw (1,-0.25)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$sp^2$};
        \draw[-,dashed](2,-0.25)--(4,5);
        \draw[-,dashed](2,-0.25)--(4,-1.5);
        \draw (1,2.25)--++(.5,0)node{$\uparrow$}-- ++(.5,0)node[below]{$2p$};
        \draw[-,dashed](2,2.25)--(4,4);
        \draw[-,dashed](2,2.25)--(4,1);
        \draw (4,-1.5)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (4,-1.5)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{$\sigma$};
        \draw (4,1)--++(.3,0)node{$\uparrow$}-- ++(.7,0);
        \draw (4,1)--++(.7,0)node{$\downarrow$}-- ++(.3,0)node[right]{$\pi$};
        \draw (4,4)--++(.5,0)-- ++(.5,0)node[right]{$\pi^*$};
        \draw (4,5)--++(.5,0)-- ++(.5,0)node[right]{$\sigma^*$};
...
\begin{figure}[H]
    \begin{tikzpicture}[baseline=(current bounding box.center),scale=.4]
        \draw[-](1,4)--(2,4)node[right]{$\sigma^*$};
        \draw[-](1,3)--(2,3)node[right]{$\pi^*$};
        \draw[-](1,2)--(2,2)node[right]{$n$};
        \draw[-](1,1)--(2,1)node[right]{$\pi$};
        \draw[-](1,0)--(2,0)node[right]{$\sigma$};
