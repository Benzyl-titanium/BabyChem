...
\usepackage[top=1.7cm,bottom=1.5cm,left=1cm,right=1cm,headsep=20pt,papersize={14.8cm,21cm}
]{geometry}
...
\ctexset{
  chapter={
  	name = {第,章},
  	beforeskip = -1.5cm,
  	format = \vspace*{-1.5cm}\Large\bfseries\raggedright,
  	aftername = \par\bigskip},
  section/format = \fontsize{8.5pt}{\baselineskip}\selectfont\bfseries\raggedright,
  subsection/format = \fontsize{7pt}{\baselineskip}\selectfont\bfseries\raggedright
}
...
\tikzset{> = latex, color=black}
\usetikzlibrary{decorations.markings,decorations.pathreplacing}
\tikzset{
	% style to apply some styles to each segment of a path
	on each segment/.style={draw=black,
		decorate,
		    decoration={
...
\newcommand{\dian}{\tikz{\filldraw[black](0,0)circle(1pt);}}
